...
const Hero: React.FC<HeroProps> = () => {
    ...
    return (
        <div className="flex gap-2 min-[680px]:gap-6 mb-6">
            <div className="py-2 min-[394px]:py-6  xl:py-[98px] px-2 min-[476px]:pr-[27px] lg:pr-[108px] min-[476px]:pl-[16px] lg:pl-[64px] bg-gray-100 rounded-[30px] max-h-[530px] max-w-[720px] flex-1 flex-shrink">
                <h1
                    className="text-gray-900 text-[12px] min-[394px]:text-xl min-[680px]:text-3xl md:text-5xl  not-italic font-medium leading-[116.667%] 
						-tracking-[0.02em] mb-4 min-[680px]:mb-[32px]"
                >
                    Unlock your potential with the best{' '}
                    <span
                        className="text-gray-900 bg-hero-bg text-[12px] min-[394px]:text-xl min-[680px]:text-3xl md:text-5xl italic font-normal 
                ...
                <p
                    className="text-gray-900 text-[10px] min-[448px]:text-sm min-[680px]:text-base  not-italic font-normal leading-[137.5%] 
                ...
                <button
                    className="flex justify-center items-center py-1 min-[480px]:py-4 px-8  min-[680px]:px-[88px]
            ...
            <div className="flex items-end pb-[190px] overflow-hidden justify-center bg-hero-bg   rounded-[30px]  flex-1 flex-shrink">
                <div className="  relative border-2 border-solid border-red-500 min-w-[339px] min-[900px]:min-h-[196px] min-[900px]:max-h-[196px]">
                    {' '}
